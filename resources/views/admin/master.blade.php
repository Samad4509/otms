                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('category.add')}}" class="slide-item">Add category</a></li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Teacher Modiul</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li><a href="{{route('teacher.create')}}" class="slide-item"> Add Teacher</a></li>
                                <li><a href="{{route('teacher.index')}}" class="slide-item"> Manage Teacher</a></li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Manage Course</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li><a href="chart-echart.html" class="slide-item"> Manage Course</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Manage Student</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">

                                <li><a href="icons.html" class="slide-item">Manage Student</a></li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M12.1124268,2.0010986C7.6941528,1.9389648,4.0620728,5.4703979,4,9.8886719c0,5.4482422,7.3642578,11.7285156,7.6777344,11.9931641C11.7677002,21.958313,11.881958,22.0001831,12,22c0.118042,0.0001831,0.2322998-0.041687,0.3222656-0.1181641C12.6357422,21.6171875,20,15.3369141,20,9.8886719C19.9391479,5.5579224,16.4431763,2.0619507,12.1124268,2.0010986z M12,20.8339844C10.5839844,19.5625,5,14.2666016,5,9.8886719C5.0353394,6.0553589,8.166626,2.973877,12,3c3.833374-0.026123,6.9647217,3.0553589,7,6.8886719C19,14.2626953,13.414978,19.5615234,12,20.8339844z M12,7c-1.6568604,0-3,1.3431396-3,3s1.3431396,3,3,3c1.6561279-0.0018311,2.9981689-1.3438721,3-3C15,8.3431396,13.6568604,7,12,7z M12,12c-1.1045532,0-2-0.8954468-2-2s0.8954468-2,2-2c1.1040039,0.0014038,1.9985962,0.8959961,2,2C14,11.1045532,13.1045532,12,12,12z"/></svg>
                                <span class="side-menu__label">Manage Enroll</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li><a href="maps1.html" class="slide-item">Manage Enroll</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">User Moudle</span><i class="angle fa fa-angle-right"></i>
                            </a>
                            <ul class="slide-menu">
                                <li><a href="alerts.html" class="slide-item">Add User </a></li>
                                <li><a href="alerts.html" class="slide-item">Manage User </a></li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="accordion.html" class="slide-item">Manage Company</a></li>
                                <li><a href="accordion.html" class="slide-item">Manage About</a></li>
                                <li><a href="accordion.html" class="slide-item">Manage Contact</a></li>
                                <li><a href="accordion.html" class="slide-item">Manage Team</a></li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-12 col-sm-12 text-center">
                    Copyright © 2023 <a href="#">Ayesh</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="#"> Noor Md Ayesh </a> All rights reserved
                </div>
            </div>
        </div>
    </footer>
...
<!-- DATA TABLE JS-->
<script src="{{asset('/')}}backemd/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/js/dataTables.buttons.min.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/js/buttons.bootstrap5.min.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/js/jszip.min.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/pdfmake/pdfmake.min.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/pdfmake/vfs_fonts.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/js/buttons.html5.min.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/js/buttons.print.min.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/js/buttons.colVis.min.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/dataTables.responsive.min.js"></script>
<script src="{{asset('/')}}backemd/assets/plugins/datatable/responsive.bootstrap5.min.js"></script>
<script src="{{asset('/')}}backemd/assets/js/table-data.js"></script>
